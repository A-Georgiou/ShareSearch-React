...
var React = _interopRequireWildcard(__webpack_require__(5232));
...
var _scrollHandler = __webpack_require__(3215);
var _react = __webpack_require__(5232);
...
var _react = _interopRequireDefault(__webpack_require__(5232));
...
exports.components={"component---src-pages-account-page-js":()=>Promise.all(/* import() | component---src-pages-account-page-js */[__webpack_require__.e(746), __webpack_require__.e(268), __webpack_require__.e(18)]).then(__webpack_require__.bind(__webpack_require__, 5491)),"component---src-pages-index-js":()=>Promise.all(/* import() | component---src-pages-index-js */[__webpack_require__.e(746), __webpack_require__.e(753), __webpack_require__.e(132), __webpack_require__.e(293)]).then(__webpack_require__.bind(__webpack_require__, 2745)),"component---src-pages-my-stocks-js":()=>Promise.all(/* import() | component---src-pages-my-stocks-js */[__webpack_require__.e(746), __webpack_require__.e(753), __webpack_require__.e(268), __webpack_require__.e(615)]).then(__webpack_require__.bind(__webpack_require__, 7950)),"component---src-pages-profile-page-js":()=>Promise.all(/* import() | component---src-pages-profile-page-js */[__webpack_require__.e(746), __webpack_require__.e(480)]).then(__webpack_require__.bind(__webpack_require__, 5363))};
...
/* harmony export */ });
var plugins=[{name:'default-site-plugin',plugin:__webpack_require__(8018),options:{"plugins":[]}},{name:'partytown',plugin:__webpack_require__(387),options:{"plugins":[]}}];/* global plugins */// During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
const trimmedPathname=stripPrefix(pathname,decodeURIComponent("/ShareSearch-React"))// Remove any hashfragment
...
const React=__webpack_require__(5232);const{grabMatchParams}=__webpack_require__(5870);const{StaticQueryContext}=__webpack_require__(123);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9226);const{ServerLocation,Router}=__webpack_require__(6462);const{renderToString}=__webpack_require__(1678);const{parse}=__webpack_require__(6192);const styleToOjbect=__webpack_require__(9108);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
;// ./src/reducers/reducer-stock.js
const initialState={stocks:[]};const stockReducer=(state=initialState,action)=>{switch(action.type){case'STOCK_UPDATE':const newStocks=JSON.parse(JSON.stringify(state));newStocks.stocks.push(action.payload);return newStocks;break;case'REMOVE_STOCK':const removedStock=JSON.parse(JSON.stringify(state));removedStock.stocks=removedStock.stocks.filter(symbol=>symbol!==action.payload);return removedStock;break;default:return state;break;}};/* harmony default export */ const reducer_stock = (stockReducer);
;// ./src/reducers/index.js
/* harmony default export */ const reducers = ((0,redux/* combineReducers */.HY)({stock:reducer_stock}));
;// ./src/state/createStore.js
const generatedStore=(0,redux/* createStore */.y$)(reducers);/* harmony default export */ const createStore = (generatedStore);
...
var dist = __webpack_require__(9396);
...
const dragOffset_initialState = {
    initialSourceClientOffset: null,
    initialClientOffset: null,
    clientOffset: null
};
function dragOffset_reduce(state = dragOffset_initialState, action) {
...
function dragOperation_reduce(state = dragOperation_initialState, action) {
    ...
    switch(action.type){
        ...
        case REMOVE_TARGET:
            ...
            return dragOperation_objectSpread({}, state, {
                targetIds: js_utils_without(state.targetIds, payload.targetId)
            });
        case DROP:
            return dragOperation_objectSpread({}, state, {
...
var DndContext = __webpack_require__(912);
...
var DndProvider = /*#__PURE__*/ (0,index_js_.memo)(function DndProvider(_param) {
...
/* harmony default export */ const wrap_with_provider = (({element})=>{// Instantiating store in `wrapRootElement` handler ensures:
//  - there is fresh store for each SSR page
//  - it will be called only once in browser, when React mounts
const store=createStore;return/*#__PURE__*/index_js_default().createElement(react_redux/* Provider */.Kq,{store:store},/*#__PURE__*/index_js_default().createElement(DndProvider,{backend:HTML5Backend},element));});
;// ./gatsby-ssr.js
const wrapRootElement=wrap_with_provider;
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(2460),e=__webpack_require__(5232),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
 ...
 * LICENSE file in the root directory of this source tree.
 */
var f=__webpack_require__(5232),k=Symbol.for("react.element"),l=Symbol.for("react.fragment"),m=Object.prototype.hasOwnProperty,n=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};
...
/* harmony export */ });
/* unused harmony exports __DO_NOT_USE__ActionTypes, applyMiddleware, compose, legacy_createStore */
 ...
 * LICENSE file in the root directory of this source tree.
 */
var g=__webpack_require__(5232);function n(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}var p="function"===typeof Object.is?Object.is:n,q=g.useSyncExternalStore,r=g.useRef,t=g.useEffect,u=g.useMemo,v=g.useDebugValue;
...
"use strict";
module.exports = require("/Users/georgioua/Projects/ShareSearch-React/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/Users/georgioua/Projects/ShareSearch-React/.cache/ssr-builtin-trackers/http");
...
"use strict";
module.exports = require("/Users/georgioua/Projects/ShareSearch-React/.cache/ssr-builtin-trackers/https");
...
"use strict";
module.exports = require("/Users/georgioua/Projects/ShareSearch-React/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/Users/georgioua/Projects/ShareSearch-React/node_modules/react/index.js");
...
/* harmony export */   Ng: () => (/* binding */ connect_default)
/* harmony export */ });
...
var useSyncExternalStoreWithSelector = (/* unused pure expression or super */ null && (notInitialized));
...
/******/ 			return "" + ({"18":"component---src-pages-account-page-js","293":"component---src-pages-index-js","480":"component---src-pages-profile-page-js","615":"component---src-pages-my-stocks-js"}[chunkId] || chunkId) + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
await apiRunnerAsync(`replaceRenderer`,{bodyComponent,replaceBodyHTMLString,setHeadComponents,setHtmlAttributes,setBodyAttributes,setPreBodyComponents,setPostBodyComponents,setBodyProps,pathname:pagePath,pathPrefix:"/ShareSearch-React"});// If no one stepped up, we'll handle it.
